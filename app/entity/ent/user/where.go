...
func HasProductsWith(preds ...predicate.ProductManager) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
// HasCreatedDevices applies the HasEdge predicate on the "created_devices" edge.
func HasCreatedDevices() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasCreatedDevicesWith applies the HasEdge predicate on the "created_devices" edge with a given conditions (other predicates).
func HasCreatedDevicesWith(preds ...predicate.Device) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newCreatedDevicesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasUpdatedDevices applies the HasEdge predicate on the "updated_devices" edge.
func HasUpdatedDevices() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasUpdatedDevicesWith applies the HasEdge predicate on the "updated_devices" edge with a given conditions (other predicates).
func HasUpdatedDevicesWith(preds ...predicate.Device) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newUpdatedDevicesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
