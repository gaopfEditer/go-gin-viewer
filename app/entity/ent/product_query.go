...
type ProductQuery struct {
	...
	withManagers         *ProductManagerQuery
...
func (pq *ProductQuery) QueryManagers() *ProductManagerQuery {
	query := (&ProductManagerClient{config: pq.config}).Query()
...
func (pq *ProductQuery) QueryLicenseTypes() *LicenseTypeQuery {
	query := (&LicenseTypeClient{config: pq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (pq *ProductQuery) QueryFeatures() *ProductFeatureQuery {
	query := (&ProductFeatureClient{config: pq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (pq *ProductQuery) QueryFirmwareVersions() *FirmwareVersionQuery {
	query := (&FirmwareVersionClient{config: pq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (pq *ProductQuery) QuerySoftwareVersions() *SoftwareVersionQuery {
	query := (&SoftwareVersionClient{config: pq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (pq *ProductQuery) QueryDevices() *DeviceQuery {
	query := (&DeviceClient{config: pq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (pq *ProductQuery) QueryAuditLogs() *AuditLogQuery {
	query := (&AuditLogClient{config: pq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (pq *ProductQuery) Clone() *ProductQuery {
	...
	return &ProductQuery{
		...
		withManagers:         pq.withManagers.Clone(),
		withLicenseTypes:     pq.withLicenseTypes.Clone(),
		withFeatures:         pq.withFeatures.Clone(),
		withFirmwareVersions: pq.withFirmwareVersions.Clone(),
		withSoftwareVersions: pq.withSoftwareVersions.Clone(),
		withDevices:          pq.withDevices.Clone(),
		withAuditLogs:        pq.withAuditLogs.Clone(),
...
func (pq *ProductQuery) WithManagers(opts ...func(*ProductManagerQuery)) *ProductQuery {
	query := (&ProductManagerClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withManagers = query
	return pq
}
...
func (pq *ProductQuery) WithLicenseTypes(opts ...func(*LicenseTypeQuery)) *ProductQuery {
	query := (&LicenseTypeClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withLicenseTypes = query
	return pq
}
...
func (pq *ProductQuery) WithFeatures(opts ...func(*ProductFeatureQuery)) *ProductQuery {
	query := (&ProductFeatureClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (pq *ProductQuery) WithFirmwareVersions(opts ...func(*FirmwareVersionQuery)) *ProductQuery {
	query := (&FirmwareVersionClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withFirmwareVersions = query
	return pq
}
...
func (pq *ProductQuery) WithSoftwareVersions(opts ...func(*SoftwareVersionQuery)) *ProductQuery {
	query := (&SoftwareVersionClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withSoftwareVersions = query
	return pq
}
...
func (pq *ProductQuery) WithAuditLogs(opts ...func(*AuditLogQuery)) *ProductQuery {
	query := (&AuditLogClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withAuditLogs = query
	return pq
}
...
func (pq *ProductQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Product, error) {
	var (
		...
		loadedTypes = [7]bool{
			pq.withManagers != nil,
			pq.withLicenseTypes != nil,
			pq.withFeatures != nil,
			pq.withFirmwareVersions != nil,
			pq.withSoftwareVersions != nil,
			pq.withDevices != nil,
			pq.withAuditLogs != nil,
		}
	)
	...
	if query := pq.withManagers; query != nil {
		if err := pq.loadManagers(ctx, query, nodes,
			func(n *Product) { n.Edges.Managers = []*ProductManager{} },
			func(n *Product, e *ProductManager) { n.Edges.Managers = append(n.Edges.Managers, e) }); err != nil {
			return nil, err
		}
	}
	if query := pq.withLicenseTypes; query != nil {
		if err := pq.loadLicenseTypes(ctx, query, nodes,
			func(n *Product) { n.Edges.LicenseTypes = []*LicenseType{} },
			func(n *Product, e *LicenseType) { n.Edges.LicenseTypes = append(n.Edges.LicenseTypes, e) }); err != nil {
			return nil, err
		}
	}
	if query := pq.withFeatures; query != nil {
		if err := pq.loadFeatures(ctx, query, nodes,
			func(n *Product) { n.Edges.Features = []*ProductFeature{} },
			func(n *Product, e *ProductFeature) { n.Edges.Features = append(n.Edges.Features, e) }); err != nil {
			return nil, err
		}
	}
	if query := pq.withFirmwareVersions; query != nil {
		if err := pq.loadFirmwareVersions(ctx, query, nodes,
			func(n *Product) { n.Edges.FirmwareVersions = []*FirmwareVersion{} },
			func(n *Product, e *FirmwareVersion) { n.Edges.FirmwareVersions = append(n.Edges.FirmwareVersions, e) }); err != nil {
			return nil, err
		}
	}
	if query := pq.withSoftwareVersions; query != nil {
		if err := pq.loadSoftwareVersions(ctx, query, nodes,
			func(n *Product) { n.Edges.SoftwareVersions = []*SoftwareVersion{} },
			func(n *Product, e *SoftwareVersion) { n.Edges.SoftwareVersions = append(n.Edges.SoftwareVersions, e) }); err != nil {
			return nil, err
		}
	}
	if query := pq.withDevices; query != nil {
		if err := pq.loadDevices(ctx, query, nodes,
			func(n *Product) { n.Edges.Devices = []*Device{} },
			func(n *Product, e *Device) { n.Edges.Devices = append(n.Edges.Devices, e) }); err != nil {
			return nil, err
		}
	}
	if query := pq.withAuditLogs; query != nil {
		if err := pq.loadAuditLogs(ctx, query, nodes,
			func(n *Product) { n.Edges.AuditLogs = []*AuditLog{} },
			func(n *Product, e *AuditLog) { n.Edges.AuditLogs = append(n.Edges.AuditLogs, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (pq *ProductQuery) loadManagers(ctx context.Context, query *ProductManagerQuery, nodes []*Product, init func(*Product), assign func(*Product, *ProductManager)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(productmanager.FieldProductID)
	}
	query.Where(predicate.ProductManager(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.ManagersColumn), fks...))
	}))
...
func (pq *ProductQuery) loadLicenseTypes(ctx context.Context, query *LicenseTypeQuery, nodes []*Product, init func(*Product), assign func(*Product, *LicenseType)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Product)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(licensetype.FieldProductID)
	}
	query.Where(predicate.LicenseType(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.LicenseTypesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (pq *ProductQuery) loadFeatures(ctx context.Context, query *ProductFeatureQuery, nodes []*Product, init func(*Product), assign func(*Product, *ProductFeature)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Product)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(productfeature.FieldProductID)
	}
	query.Where(predicate.ProductFeature(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.FeaturesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (pq *ProductQuery) loadFirmwareVersions(ctx context.Context, query *FirmwareVersionQuery, nodes []*Product, init func(*Product), assign func(*Product, *FirmwareVersion)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Product)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(firmwareversion.FieldProductID)
	}
	query.Where(predicate.FirmwareVersion(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.FirmwareVersionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (pq *ProductQuery) loadSoftwareVersions(ctx context.Context, query *SoftwareVersionQuery, nodes []*Product, init func(*Product), assign func(*Product, *SoftwareVersion)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Product)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(softwareversion.FieldProductID)
	}
	query.Where(predicate.SoftwareVersion(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.SoftwareVersionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (pq *ProductQuery) loadDevices(ctx context.Context, query *DeviceQuery, nodes []*Product, init func(*Product), assign func(*Product, *Device)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Product)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(device.FieldProductID)
	}
	query.Where(predicate.Device(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.DevicesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (pq *ProductQuery) loadAuditLogs(ctx context.Context, query *AuditLogQuery, nodes []*Product, init func(*Product), assign func(*Product, *AuditLog)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Product)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(auditlog.FieldProductID)
	}
	query.Where(predicate.AuditLog(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.AuditLogsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
