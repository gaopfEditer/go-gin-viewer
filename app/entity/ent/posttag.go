...
type PostTagEdges struct {
	// 标签文章关系
	PostRelations []*PostTagRelation `json:"post_relations,omitempty"`
	// loadedTypes holds the information for reporting if a
	// type was loaded (or requested) in eager-loading or not.
	loadedTypes [1]bool
}

// PostRelationsOrErr returns the PostRelations value or an error if the edge
// was not loaded in eager-loading.
func (e PostTagEdges) PostRelationsOrErr() ([]*PostTagRelation, error) {
	if e.loadedTypes[0] {
		return e.PostRelations, nil
	}
	return nil, &NotLoadedError{edge: "post_relations"}
}
...
func (*PostTag) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case posttag.FieldID, posttag.FieldPostCount:
			values[i] = new(sql.NullInt64)
		case posttag.FieldName, posttag.FieldSlug, posttag.FieldDescription, posttag.FieldColor:
...
// QueryPostRelations queries the "post_relations" edge of the PostTag entity.
func (pt *PostTag) QueryPostRelations() *PostTagRelationQuery {
	return NewPostTagClient(pt.config).QueryPostRelations(pt)
}
...
func (pt *PostTag) String() string {
	...
	builder.WriteString(pt.Color)
	builder.WriteString(", ")
	builder.WriteString("post_count=")
	builder.WriteString(fmt.Sprintf("%v", pt.PostCount))
	builder.WriteString(", ")
